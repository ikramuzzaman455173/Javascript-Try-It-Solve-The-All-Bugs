...
const displayMealInfo = mealData => {
    console.log("🚀 ~ file: app.js:15 ~ displayMealInfo ~ mealData:", mealData)
...
const dataErase = mealItemName => {
    let mealItemsInformation = document.getElementById(mealItemName);
    // console.log("🚀 ~ file: app.js:87 ~ dataErase ~ mealItemsInformation:", mealItemsInformation)
